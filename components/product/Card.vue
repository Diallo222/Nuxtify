<template lang="pug">
    .p-2.relative.space-y-2(class="w-[16rem]")
        ...
        button.w-full.border.border-black.p-2.transition.uppercase(class="hover:bg-zinc-900 hover:text-white hover:scale-110") Add to cart
</template>
